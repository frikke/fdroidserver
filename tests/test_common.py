...
class IsV1SignedOnly(unittest.TestCase):
    def test_v1_janus(self):
        path = str(Path(__file__).absolute().parent / 'janus.apk')
        self.assertTrue(fdroidserver.common.apk_is_v1_signed_only(path))
    ...
    def test_v2(self):
        ...
        self.assertFalse(fdroidserver.common.apk_is_v1_signed_only(path))
